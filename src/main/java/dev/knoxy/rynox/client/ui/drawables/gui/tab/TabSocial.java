package dev.knoxy.rynox.client.ui.drawables.gui.tab;
...
public class TabSocial extends Drawable implements MC {
    public Identifier social = new Identifier("rynox", "icons/other/social.png");
    ...
    public void render(int n, int n2, float f, float f2) {
        ...
        RenderUtil.renderRoundedRect(getX() + getWidth() - 60, getY() + 5, getX() + getWidth() - 45, getY() + 20, RenderUtil.getColor(fuckoff == 0 ? Color.WHITE : RenderUtil.getColor(-2, 1), f2), 5);
        ...
        RenderUtil.renderRoundedRect(getX() + getWidth() - 40, getY() + 5, getX() + getWidth() - 25, getY() + 20, RenderUtil.getColor(fuckoff == 1 ? Color.WHITE : RenderUtil.getColor(-2, 1), f2), 5);
        ...
        RenderUtil.renderRoundedRect(getX() + getWidth() - 20, getY() + 5, getX() + getWidth() - 5, getY() + 20, RenderUtil.getColor(fuckoff == -1 ? Color.WHITE : RenderUtil.getColor(-2, 1), f2), 5);
        ...
        for (PlayerListEntry playerListEntry : getMc().getNetworkHandler().getPlayerList()) {
            ...
            switch (fuckoff) {
                case -1 -> {
                    if (!Rynox.Companion.getSocialsManager().isEnemy(string)) continue;
                }
                case 0 -> {
                    if (Rynox.Companion.getSocialsManager().isFriend(string) || Rynox.Companion.getSocialsManager().isEnemy(string)) continue;
                }
                case 1 -> {
                    if (!Rynox.Companion.getSocialsManager().isFriend(string)) continue;
                }
            }
            if (n3 < 8) {
    ...
    void drawPlayer(PlayerListEntry playerListEntry, float f, float f2, float f3, int n, int n2, int n3, float f4) {
        ...
        FontRenderer font = Rynox.Companion.getFontManager().getFontRenderer();
        font.drawString(name, (f + 15) / f6, (f2 + 1.5f) / f6, RenderUtil.getColor(Rynox.Companion.getSocialsManager().getColor(name), f4));
        font.drawString(String.valueOf(Rynox.Companion.getSocialsManager().getType(name)), (f + f3 - 19 - font.getStringWidth(String.valueOf(Rynox.Companion.getSocialsManager().getType(name))) / 2) / f6, f2 / f6, RenderUtil.getColor(Rynox.Companion.getSocialsManager().getColor(name), f4));
        matrixStack.pop();
        ...
        if (n3 == 0) {
            if (n > f + f3 - 37.5 && n < f + f3 - 27.5 && n2 > f2 + 2.5 && n2 < f2 + f5 - 2.5) {
                if (Rynox.Companion.getSocialsManager().isFriend(name)) {
                    Rynox.Companion.getSocialsManager().removeFriend(name);
                } else if (!Rynox.Companion.getSocialsManager().isEnemy(name)) {
                    Rynox.Companion.getSocialsManager().addEnemy(name);
                }
            }
            if (n > f + f3 - 12.5 && n < f + f3 - 2.5 && n2 > f2 + 2.5 && n2 < f2 + f5 - 2.5) {
                if (Rynox.Companion.getSocialsManager().isEnemy(name)) {
                    Rynox.Companion.getSocialsManager().removeEnemy(name);
                } else if (!Rynox.Companion.getSocialsManager().isFriend(name)) {
                    Rynox.Companion.getSocialsManager().addFriend(name);
                }
            }
        }
    }
