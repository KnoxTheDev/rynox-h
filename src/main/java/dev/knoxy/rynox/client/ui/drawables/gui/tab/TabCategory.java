...
import dev.knoxy.rynox.client.ui.drawables.gui.buttons.ModuleButton;
...
public class TabCategory extends Drawable {
    ...
    public TabCategory(Category category, float f, float f2, float f3, float f4) {
        ...
        dispatched = category;
        categoryTexture = new Identifier("rynox", "icons/categories/" + dispatched.name().toLowerCase(Locale.ROOT) + ".png");
