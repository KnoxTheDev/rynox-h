...
public class DragButton extends SettingsDrawable {
    ...
    public void renderButton(int n, int n2, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        RenderUtil.renderFilledCircle(getX() + getWidth() * f11, getY() + getHeight() - 1, 3.5f, RenderUtil.getColor(Color.WHITE, f2));
        ...
        RenderUtil.renderFilledCircle(getX() + getWidth() * f12, getY() + getHeight() - 1, 3.5f, RenderUtil.getColor(Color.WHITE, f2));
        RenderUtil.renderColoredQuad(getX() + getWidth() * f11, getY() + getHeight() - 2, getX() + getWidth() * f12, getY() + getHeight(), RenderUtil.getColor(Color.WHITE, f2));
        if (dragging) {
