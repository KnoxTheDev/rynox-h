package dev.knoxy.rynox.client.ui;
...
import dev.knoxy.rynox.client.ui.drawables.gui.tab.TabCategory;
import dev.knoxy.rynox.client.ui.drawables.gui.tab.TabSocial;
...
public class Interface extends DrawableScreen implements MC {
    ...
    public Identifier socialImage = new Identifier("rynox", "icons/other/social.png");
    public Identifier searchImage = new Identifier("rynox", "icons/search.png");
    ...
    public void render(DrawContext drawContext, int n, int n2, float f) {
        ...
        if (notLoaded) {
            for (Category category : Category.values()) {
                tabs.add(new TabCategory(category, f2, 5, 120, 20));
                f2 += 130;
            }
            notLoaded = false;
        }
