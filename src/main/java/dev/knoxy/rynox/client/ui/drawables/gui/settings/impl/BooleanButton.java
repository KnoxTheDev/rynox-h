...
public class BooleanButton extends SettingsDrawable {
    ...
    public void renderButton(int n, int n2, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        RenderUtil.renderRoundedRect(getX() + getWidth() - 20, getY() + 3, getX() + getWidth(), getY() + 12, RenderUtil.getColor(Color.WHITE, f2 * 0.5f), 4.5f);
        GL11.glDisable(3089);
        ...
        RenderUtil.renderFilledCircle(getX() + getWidth() - 20 * (1 - anims.getAnimationFactor()), getY() + 7.5f, 5, RenderUtil.getColor(Color.WHITE, f2));
        GL11.glDisable(3089);
        setHeight(15);
    }
