...
public class FloatButton extends SettingsDrawable {
    ...
    public void renderButton(int n, int n2, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        RenderUtil.renderColoredQuad(getX(), getY() + getHeight() - 2, getX() + getWidth() * f8, getY() + getHeight(), RenderUtil.getColor(Color.WHITE, f2));
        RenderUtil.renderFilledCircle(getX() + getWidth() * f8, getY() + getHeight() - 1, 4, RenderUtil.getColor(-3, f2));
        RenderUtil.renderFilledCircle(getX() + getWidth() * f8, getY() + getHeight() - 1, 3.5f, RenderUtil.getColor(Color.WHITE, f2));
        if (dragging) {
