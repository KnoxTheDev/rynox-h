...
import dev.knoxy.rynox.client.setting.impl.ColorSetting;
import dev.knoxy.rynox.client.setting.impl.DragSetting;
import dev.knoxy.rynox.client.setting.impl.FloatSetting;
import dev.knoxy.rynox.client.setting.impl.IntSetting;
import dev.knoxy.rynox.client.setting.impl.ModeSetting;
import dev.knoxy.rynox.client.setting.impl.MultipleSetting;
import dev.knoxy.rynox.client.setting.impl.StringSetting;
import dev.knoxy.rynox.client.ui.Interface;
import dev.knoxy.rynox.client.ui.drawables.Drawable;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.SettingsDrawable;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.BindButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.BooleanButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.ColorButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.DragButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.FloatButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.IntButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.ModeButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.MultipleButton;
import dev.knoxy.rynox.client.ui.drawables.gui.settings.impl.StringButton;
import dev.knoxy.rynox.client.util.impl.MathUtil;
import dev.knoxy.rynox.client.util.impl.RenderUtil;
import dev.knoxy.rynox.client.util.impl.animation.Animation;
import dev.knoxy.rynox.client.util.impl.animation.Easing;
...
public class ModuleButton extends Drawable {
    ...
    public void render(int n, int n2, float f, float f2) {
        ...
        RenderUtil.renderColoredQuad(getX(), getY(), getX() + getWidth(), getY() + 15.0f, RenderUtil.getColor(Color.WHITE, enabled * f2));
        Rynox.Companion.getFontManager().getFontRenderer().drawString(module.getName(), getX() + 2.5f, getY() + 5.0f - Rynox.Companion.getFontManager().getFontRenderer().getStringHeight() / 2.0f, RenderUtil.getColor(animationTime, f2));
